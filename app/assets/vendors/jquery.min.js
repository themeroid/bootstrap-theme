...
!(function (e, t) {
  ...
  function m (e, t, n) {
    ...
    var o = (t = t || r).createElement('script')
  ...
  w.extend({
    ...
    map: function (e, t, n) {
      ...
      var s = []
      if (C(e)) {
        for (r = e.length; o < r; o++) { (i = t(e[o], o, n)) != null && s.push(i) }
  ...
  var E = (function (e) {
    ...
    var Z = new RegExp('\\\\([\\da-f]{1,6}' + M + '?|(' + M + ')|.)', 'ig')
    ...
    function oe (e, t, r, i) {
      ...
      var m = t && t.ownerDocument

      var T = t ? t.nodeType : 9
      if (
        ((r = r || []),
    ...
    function Ee (e, t) {
      ...
      var o = function (o, a, s, u, c) {
        ...
        var E = (T += w == null ? 1 : Math.random() || 0.1)
  ...
  function ue (e, t, n, r) {
    ...
    var c = (w.cssNumber[t] || (l !== 'px' && +u)) && ie.exec(w.css(e, t))
    if (c && c[3] !== l) {
      ;(u /= 2), (l = l || c[3]), (c = +u || 1)
      while (a--) {
        w.style(e, t, c + l),
  ...
  var Te = /^(?:mouse|pointer|contextmenu|drag|drop)|click/
  ...
  var Ye = r.createElement('div').style
  function Qe (e) {
    if (e in Ye) return e
  ...
  function et (e, t, n) {
    ...
    var o = w.css(e, 'boxSizing', !1, r) === 'border-box'
  ...
  w.each(['height', 'width'], function (e, t) {
    w.cssHooks[t] = {
      ...
      set: function (e, n, r) {
        ...
        var a = w.css(e, 'boxSizing', !1, o) === 'border-box'
  ...
  (function () {
    ...
    var t = r.createElement('select').appendChild(r.createElement('option'))
      ;(e.type = 'checkbox'),
    (h.checkOn = e.value !== ''),
  ...
  var At = /^(?:input|select|textarea|keygen)/i
  function jt (e, t, n, r) {
    var i
    if (Array.isArray(t)) {
  ...
  function zt (e, t) {
    ...
    var i = w.ajaxSettings.flatOptions || {}
